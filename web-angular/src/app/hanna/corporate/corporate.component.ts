...
export class CorporateComponent implements OnInit {
    ...
    get() {
        this.individualService.getCorporate().subscribe((data: Object[]) => {
            this.evtProses = true;
            this.list = data;
    ...
    save(evt: any) {
        if (evt) {
            if (this.validation()) {
                this.individual.typeInteractive = "C";
    ...
    validation(): boolean{
        ...
        if (this.individual.searchType == 0) {
            if(this.individual.refUserCode != null && this.individual.reqPurposeId != null && this.individual.npwp != null){
                valid = true;
            }
        } else {
            if(this.individual.refUserCode != null && this.individual.reqPurposeId != null && this.individual.debiturName != null && this.individual.placeOfBirth != null && this.individual.dateOfBirth != null){
                valid = true;
            }
        }
        return valid;
    ...
    changeClass(value: any): String {
        let flag: String = 'btn btn-primary btn-sm';
        if (value === 1) {
            flag = 'btn btn-primary btn-sm disabled';
        }
        return flag;
    }
}
